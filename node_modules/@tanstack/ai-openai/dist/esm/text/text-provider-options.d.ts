...
import { ComputerUseTool } from '../tools/computer-use-tool.js';
...
import { LocalShellTool } from '../tools/local-shell-tool.js';
import { MCPTool } from '../tools/mcp-tool.js';
import { ShellTool } from '../tools/shell-tool.js';
import { ToolChoice } from '../tools/tool-choice.js';
import { WebSearchPreviewTool } from '../tools/web-search-preview-tool.js';
...
export type ExternalTextProviderOptions = OpenAIBaseOptions & OpenAIReasoningOptions & OpenAIStructuredOutputOptions & OpenAIToolsOptions & OpenAIStreamingOptions & OpenAIMetadataOptions;
/**
...
export interface InternalTextProviderOptions extends ExternalTextProviderOptions {
  ...
  https://platform.openai.com/docs/api-reference/responses/create#responses_create-instructions
     ...
     */
    tools?: Array<FunctionTool | FileSearchTool | ComputerUseTool | WebSearchTool | MCPTool | CodeInterpreterTool | ImageGenerationTool | ShellTool | LocalShellTool | CustomTool | WebSearchPreviewTool | ApplyPatchTool>;
}
export declare const validateTextProviderOptions: (options: InternalTextProviderOptions) => void;
export {};
