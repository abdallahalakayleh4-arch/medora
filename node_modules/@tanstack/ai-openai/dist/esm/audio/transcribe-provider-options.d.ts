...
export declare const validateTemperature: (options: TranscribeProviderOptions) => void;
export declare const validateStream: (options: TranscribeProviderOptions) => void;
export declare const validatePrompt: (options: TranscribeProviderOptions) => void;
export declare const validateKnownSpeakerNames: (options: TranscribeProviderOptions) => void;
export declare const validateInclude: (options: TranscribeProviderOptions) => void;
