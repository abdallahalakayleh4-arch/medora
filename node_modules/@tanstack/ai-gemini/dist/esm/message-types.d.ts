 ...
 */
export type GeminiImageMimeType = 'image/png' | 'image/jpeg' | 'image/webp' | 'image/heic' | 'image/heif';
/**
 * Supported audio MIME types for Gemini.
 */
export type GeminiAudioMimeType = 'audio/wav' | 'audio/mp3' | 'audio/aiff' | 'audio/aac' | 'audio/ogg' | 'audio/flac';
/**
 * Supported video MIME types for Gemini.
 */
export type GeminiVideoMimeType = 'video/mp4' | 'video/mpeg' | 'video/mov' | 'video/avi' | 'video/x-flv' | 'video/mpg' | 'video/webm' | 'video/wmv' | 'video/3gpp';
/**
 * Supported document MIME types for Gemini.
 */
export type GeminiDocumentMimeType = 'application/pdf' | 'text/plain' | 'text/html' | 'text/css' | 'text/javascript' | 'application/x-javascript' | 'text/x-typescript' | 'application/x-typescript' | 'text/csv' | 'text/markdown' | 'application/json' | 'application/xml';
/**
